...
import { monthlyDetections, riskDistribution, alerts, mapPoints } from '@/data/mockData';
...
const AdminDashboard = () => (
  <div className="space-y-6">
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="rounded-xl border border-border bg-card p-6">
      <h3 className="text-lg font-semibold text-card-foreground mb-4">Regional Overview</h3>
      <MapView points={mapPoints} className="h-[400px]" />
    </motion.div>
