...
const navItems = {
  admin: [
    ...
    { title: 'Complaints', path: '/admin/complaints', icon: MessageSquare },
  ...
  officer: [
    ...
    { title: 'Complaints', path: '/officer/complaints', icon: FileWarning },
  ...
  viewer: [
    ...
    { title: 'Map', path: '/viewer/map', icon: Map },
    { title: 'Report Violation', path: '/viewer/complaints', icon: MessageSquare },
    { title: 'My Complaints', path: '/viewer/my-complaints', icon: FileWarning },
